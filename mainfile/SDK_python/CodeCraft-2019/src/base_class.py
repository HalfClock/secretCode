...
include cross:
    ...
    def init_map_of_diff_speed(self, car_speed_list):
        ...
        """
        max_car_speed = max(car_speed_list)
        road_dict = self.road_dict
        speed_dict = {}
        # for car_speed in car_speed_list:
        #     if car_speed in speed_dict:
        #         pass
        #     else:
        ...
        for road in road_dict:
            ...
            final_speed = min(road_limit_speed, max_car_speed)
            if final_speed not in speed_dict:
                speed_dict[final_speed] = []
            if road_dict[road].is_dual:
                speed_dict[final_speed].append((road_dict[road].orig_id,
                                                road_dict[road].dest_id,
                                                road_dict[road].road_len // final_speed))
                speed_dict[final_speed].append((road_dict[road].dest_id,
